    ...
    for k in tqdm( race_data.keys() ):
        ...
        for kk in race_data[k].keys():
            ...
            if len( current_data ) == 22:
                ...
                lib.dicAppend( result, key_race_kind, {} )
                lib.dicAppend( result[key_race_kind], key_dist, {} )
                lib.dicAppend( result[key_race_kind][key_dist], key_baba, {} )
                lib.dicAppend( result[key_race_kind][key_dist][key_baba], key_limb, \
                ...
                result[key_race_kind][key_dist][key_baba][key_limb]["time"] += cd.raceTime()
                result[key_race_kind][key_dist][key_baba][key_limb]["up_time"] += cd.upTime()
