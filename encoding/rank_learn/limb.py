...
def main():
    ...
    for k in tqdm( race_data.keys() ):
        ...
        for kk in race_data[k].keys():
            ...
            lib.dicAppend( instance_dict["one"], key_limb, { "data": 0, "count": 0 } )
            lib.dicAppend( instance_dict["two"], key_limb, { "data": 0, "count": 0 } )
            lib.dicAppend( instance_dict["three"], key_limb, { "data": 0, "count": 0 } )            
