...
def main():
    ...
    for k in tqdm( race_data.keys() ):
        ...
        for kk in race_data[k].keys():
            ...
            lib.dic_append( instance_dict, key_limb, { "data": 0, "count": 0 } )
            
            if first_horce_body == 0:
                instance_dict[key_limb]["data"] += 1
    ...
    for k in instance_dict.keys():
        result[current_key][k] = 0
        result[current_key][k] = instance_dict[k]["data"] / instance_dict[k]["count"]  
        print( "limb:{} horce_body:{}%".format( k, str( result[current_key][k] * 100 ) ) )
