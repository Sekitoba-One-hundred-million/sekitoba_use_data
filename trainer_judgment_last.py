...
def main():
    ...
    for i, std in enumerate( sort_time_data ):
        ...
        for kk in race_data[k].keys():
            ...
            for param in param_list:
                ...
                trainer_judgment[trainer_id][param][key_data[param]]["score"] += last_passing_rank
    ...
    dm.pickle_upload( "trainer_judgment_last_data.pickle", dev_result )
    dm.pickle_upload( "trainer_judgment_last_data.pickle", trainer_judgment )
